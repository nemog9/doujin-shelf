...
※100％コーディングAIで書いてます。自己責任でご利用ください。
※iOSもCSVがあればある程度動くと思いますが動作未確認です。取得は動かないと思います。

Androidアプリはデータ取得が載っていますが、iOSおよびデスクトップ版には載っていないのでChrome拡張を使うといい感じになると思います。

https://github.com/nemog9/dmm-doujin-exporter
...
- 🔄 **ライブラリ自動取得** — Fから始まる同人サイトの購入済み作品を Android 上で取得。
- 🔍 **検索 & 絞り込み** — タイトル・サークル・声優名で検索、ジャンルフィルター付き
- ♡ **お気に入り** — よく見る作品をすぐ手元に
